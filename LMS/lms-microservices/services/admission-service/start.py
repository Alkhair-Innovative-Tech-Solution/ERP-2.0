#!/usr/bin/env python
"""Startup script for admission-service"""
import os
import sys
import subprocess
import time
...
if not db_url:
    ...
    db_host = os.getenv('DB_HOST', 'postgres-admission')
...
if __name__ == '__main__':
    ...
    import subprocess
    try:
        subprocess.run(['gunicorn', 'admission_service.wsgi:application', '--bind', '0.0.0.0:8003', '--workers', '4', '--timeout', '120', '--access-logfile', '-', '--error-logfile', '-'])
