        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5">
          ...
          {loading ? (
            ...
            <div className="py-8 text-center">
              ...
              <p className="text-xs text-gray-400 mt-1">Create one from the admin panel — it will appear here.</p>
            </div>
          ) : (
            <div className="space-y-2.5">
              {announcements.slice(0, 5).map((a, i) => {
                ...
                const prStyle = pr === "urgent"
                  ? { bg: "bg-rose-50", text: "text-rose-700", dot: "#EF4444" }
                  : pr === "important"
                    ? { bg: "bg-amber-50", text: "text-amber-700", dot: "#F59E0B" }
                    : { bg: "bg-[#6096ba]/10", text: "text-[#274c77]", dot: "#6096ba" }
                return (
