...
function Skeleton({
  ...
  return (
    <div
      className={cn("animate-pulse rounded-md bg-blue-50/80", className)}
      {...props}
    />
  )
}
...
function KpiCardSkeleton() {
  return (
    <div className="rounded-[24px] bg-white p-6 shadow-soft border border-blue-50 relative overflow-hidden h-full min-h-[160px]">
      ...
      <div className="relative h-full flex flex-col justify-between">
        <div className="space-y-4">
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              ...
              <Skeleton className="h-8 w-12 bg-blue-50" />
            </div>
            {/* Animated icon placeholder */}
            <div className="h-12 w-12 rounded-2xl bg-blue-50/50 flex items-center justify-center border border-blue-100/20">
              <div className="h-6 w-6 bg-blue-100 rounded-lg animate-pulse" />
            </div>
          </div>

          {/* Animated number visualization */}
          <div className="flex items-end gap-1.5 h-12 pt-2">
            {[40, 70, 50, 90, 65, 80, 55].map((height, i) => (
              <div
                key={i}
                className="flex-1 bg-gradient-to-t from-blue-100/40 to-transparent rounded-t-md animate-pulse"
                style={{
                  height: `${height}%`,
                  animationDelay: `${i * 0.1}s`,
        ...
        <div className="mt-4 pt-4 border-t border-blue-50/50">
           <Skeleton className="h-3 w-3/4 bg-blue-50" />
        </div>
      </div>
