...
export const FEATURES: FeatureDefinition[] = [
    ...
    },
    {
        ...
        description: "Teacher and coordinator timetables, timetable settings, shift timings, and subject management",
        navItems: [
            "timetable",
    ...
    },
    {
        ...
        description: "Subjects, content, assignments — admin manage, teacher create, student view",
        navItems: [],
        routes: [
            "/admin/subjects",
            "/teacher/subjects",
