...
if EMAIL_HOST_USER and EMAIL_HOST_PASSWORD:
    ...
    DEFAULT_FROM_EMAIL = DEFAULT_FROM_EMAIL or "noreply@localhost"
FRONTEND_URL = os.getenv("FRONTEND_URL", "http://localhost:3000")

STATIC_URL = "/sms-admin/static/"
...
# ── Django admin over the gateway (https://ams.idaraalkhair.sbs/sms-admin/) ──
