...
export function WorkAssignmentStep({ formData, onInputChange, invalidFields, campuses, levels, onShiftChange, formOptions, shiftOptions }: WorkAssignmentStepProps) {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            >
              ...
              <SelectContent className="rounded-xl">
                {(shiftOptions || formOptions?.shift || [
