#!/usr/bin/env python
"""
Startup script for certification-service
"""
import os
import sys
import subprocess

print("=== STARTING START.PY ===", flush=True)
...
def main():
    print("🚀 Starting certification-service...")
    ...
    try:
        subprocess.run(['gunicorn', 'certification_service.wsgi:application', '--bind', '0.0.0.0:8004', '--workers', '4', '--timeout', '120', '--access-logfile', '-', '--error-logfile', '-'])
