    ...
    <Card className="border-2 bg-white">
      ...
      <CardContent className="space-y-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <Label htmlFor="emergency_relationship">Relative's Relation to Student (Emergency Contact)</Label>
          ...
          {formData.fatherStatus === "dead" && (
            <>
              ...
              <div>
                <Label htmlFor="guardianRelation">Guardian's Relation to Student *</Label>
                <Input
                  id="guardianRelation"
          ...
          <div>
            <Label htmlFor="siblingsCount">Number of Siblings Enrolled in School *</Label>
            <Input
              id="siblingsCount"
              type="number"
              min="0"
