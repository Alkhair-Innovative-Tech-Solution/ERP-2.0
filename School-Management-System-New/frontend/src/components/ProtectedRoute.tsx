...
const DEVELOPMENT_PHASE_ROUTES: Record<string, string> = {
  // '/coordinator/time-table': 'Time Table Management',
  ...
  // '/coordinator/result-approval': 'Result Approval',
  // '/admin/principals/transfers': 'Transfer Management',
  // '/admin/principals/transfers/create': 'Create Transfer',
  // '/coordinator/requests' : 'Requests Management',
  // '/principal/shift-timings': 'Shift Timings',
  // '/principal/result-approval': 'Result Approval',
};
