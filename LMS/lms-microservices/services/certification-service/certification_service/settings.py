"""
Django settings for certification_service.
"""
import os
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'certification_db'),
        'USER': os.getenv('DB_USER', 'lms_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'lms_password'),
        'HOST': os.getenv('DB_HOST', 'postgres-certification'),
...
# Static files
FORCE_SCRIPT_NAME = '/d-certification'
STATIC_URL = '/static/'
