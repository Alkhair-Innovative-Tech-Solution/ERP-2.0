...
SECRET_KEY = os.getenv("SECRET_KEY", "subject-service-secret")
...
ROOT_URLCONF = "subject_service.urls"
WSGI_APPLICATION = "subject_service.wsgi.application"
...
DATABASES = {
    "default": {
        ...
        "NAME": os.getenv("DB_NAME", "subject_db"),
        "USER": os.getenv("DB_USER", "subject_user"),
        "PASSWORD": os.getenv("DB_PASSWORD", "subject_pass"),
        "HOST": os.getenv("DB_HOST", "postgres-subject"),
...
CACHES = {
    "default": {
        ...
        "LOCATION": os.getenv("REDIS_URL", "redis://redis:6379/12"),
...
STATIC_URL = "/subject-admin/static/"
...
# Suppress cross-service model warnings
SILENCED_SYSTEM_CHECKS = ["fields.E300", "fields.E307"]

# ── Django admin over the gateway (https://ams.idaraalkhair.sbs/subject-admin/) ──
...
SESSION_COOKIE_NAME = "subject_sessionid"
CSRF_COOKIE_NAME = "subject_csrftoken"
