...
class Invoice(models.Model):
    ...
    invoice_type = models.CharField(max_length=10, choices=TYPE_CHOICES, default='initial')
    ...
    receipt = models.FileField(upload_to='invoices/receipts/', null=True, blank=True)
