...
from .models import Attendance, StudentAttendance, Weekend, Holiday, BiometricDevice, BiometricEmployeeMapping, StaffAttendance, EmployeeShiftTiming
...
class BiometricDeviceAdmin(admin.ModelAdmin):
    list_display = ['name', 'device_type', 'ip_address', 'serial_number', 'device_model', 'campus', 'organization', 'is_active', 'last_sync', 'created_at']
    list_filter = ['organization', 'campus', 'device_type', 'is_active']
    ...
    fieldsets = (
        ('Device Info', {
            'fields': ('name', 'device_type', 'ip_address', 'port', 'serial_number', 'device_model')
        }),
        ('Assignment', {
...
@admin.register(BiometricEmployeeMapping)
class BiometricEmployeeMappingAdmin(admin.ModelAdmin):
