...
export function WeeklyAttendanceChart({ data, isLoading, campusId, period, onPeriodChange }: WeeklyAttendanceChartProps) {
  ...
  const handleDownloadCsv = async () => {
    ...
    try {
      ...
      if (campusId) params.append('campus', String(campusId))
    ...
    return (
      <Card className="h-[400px] border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-2xl flex flex-col bg-white">
        <CardHeader className="pb-2">
          <CardTitle className="text-lg font-bold text-[#163B5C]">Attendance Overview</CardTitle>
        </CardHeader>
    ...
    <Card className="h-auto lg:h-[400px] border-none shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)] transition-all duration-300 rounded-2xl flex flex-col bg-white overflow-hidden">
      <CardHeader className="pb-2 bg-white flex flex-row items-center justify-between shrink-0">
        <div className="flex items-center gap-2">
          ...
          <div>
            <CardTitle className="text-base font-bold text-[#163B5C]">Attendance Overview</CardTitle>
            <CardDescription className="text-xs text-gray-400">Student attendance breakdown</CardDescription>
          </div>
        </div>
