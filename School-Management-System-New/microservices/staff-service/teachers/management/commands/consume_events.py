...
QUEUE_NAME = "staff-service.events"
ROUTING_KEYS = [
...
class _SuperuserContext:
    """Minimal user object that satisfies is_superadmin() check in OrganizationManager."""
...
def handle_event(routing_key, payload):
    # Set superadmin context so OrganizationManager doesn't filter out records
    try:
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        self.stdout.write("Starting staff-service event consumer...")
