...
class TeacherSubjectAssignmentAdmin(admin.ModelAdmin):
    ...
    search_fields = ('teacher__full_name', 'classroom__code')


import os as _os
if not _os.environ.get("DJANGO_SETTINGS_MODULE", "").startswith("staff_service"):
    try:
        from django.contrib import admin as _admin
        from .models import Teacher as _Teacher, TeacherSubjectAssignment as _TSA
        for _m in [_Teacher, _TSA]:
            try:
