...
import { Plus, Edit, Trash2, Users, UserPlus, Clock, UserX, GraduationCap, MoreHorizontal, Download } from "lucide-react"
                    ...
                    <TableCell className="text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end" className="w-44">
                          <DropdownMenuItem onClick={() => handleViewStudents(classroom)} className="gap-2">
                            <Users className="h-4 w-4 text-blue-600" /> View Students
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleAssignTeacher(classroom)} className="gap-2">
                            <UserPlus className="h-4 w-4 text-green-600" /> Assign Teacher
                          </DropdownMenuItem>
                          <DropdownMenuItem onClick={() => handleEdit(classroom)} className="gap-2">
                            <Edit className="h-4 w-4 text-gray-600" /> Edit Classroom
                          </DropdownMenuItem>
                          <DropdownMenuSeparator />
                          <DropdownMenuItem onClick={() => handleDelete(classroom)} className="gap-2 text-red-600 focus:text-red-600">
