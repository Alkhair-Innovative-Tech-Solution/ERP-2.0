...
export function PrincipalProfilePage({ principal, stats = {}, loading = false }: Props) {
  ...
  const fallbackActions: PendingActionItem[] = [
    { title: "Result Approvals",     count: stats.pendingApprovals ?? 0, type: "urgent" as const, href: "/principal/result-approval" },
    { title: "Leave Requests",       count: 0, type: "normal" as const,  href: "/principal/requests" },
    { title: "Transfer Requests",    count: 0, type: "normal" as const,  href: "/admin/transfers"          },
    { title: "Coordinator Requests", count: 0, type: "normal" as const,  href: "/principal/requests" },
  ]
        ...
        <div className="flex flex-col lg:flex-row gap-6 items-start">
          ...
          <div className="flex-1 min-w-0 space-y-5">
            ...
            <SectionCard
              ...
              icon={ClipboardList}
              action={
                <a href="/principal/requests" className="text-xs font-semibold text-[#185FA5] hover:underline flex items-center gap-1">
            ...
            <SectionCard title="Quick Actions" icon={Star}>
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                {[
                  { label: "Result Approvals", icon: CheckCircle, href: "/principal/result-approval",   colorClass: "text-emerald-600", bgClass: "bg-emerald-50" },
                  { label: "Leave Requests",   icon: FileText,    href: "/principal/requests",          colorClass: "text-[#185FA5]",   bgClass: "bg-blue-50"    },
                  { label: "Campus Report",    icon: BarChart3,   href: "/principal/timetable-settings",colorClass: "text-violet-600",  bgClass: "bg-violet-50"  },
                  { label: "Announcements",    icon: Megaphone,   href: "/principal/shift-timings",     colorClass: "text-amber-600",   bgClass: "bg-amber-50"   },
