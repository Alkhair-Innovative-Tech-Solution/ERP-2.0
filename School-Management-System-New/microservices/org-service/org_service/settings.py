...
# ── Django admin over the gateway (https://ams.idaraalkhair.sbs/org-admin/) ──
...
SESSION_COOKIE_NAME = "org_sessionid"
CSRF_COOKIE_NAME = "org_csrftoken"
