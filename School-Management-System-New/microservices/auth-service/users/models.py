...
CODE_PATTERN_CHOICES = [
    ...
    ('PREFIX_NOSEP_SEQ4',   'KPS0001        (Prefix + Serial, no separator)'),
]

STUDENT_ID_PATTERN_CHOICES = [
...
class Organization(models.Model):
    ...
    code_prefix = models.CharField(max_length=6, unique=True, null=True, blank=True)
    code_pattern = models.CharField(max_length=30, choices=CODE_PATTERN_CHOICES, default='PREFIX_YY_ROLE_SEQ4', blank=True)
    student_id_pattern = models.CharField(max_length=30, choices=STUDENT_ID_PATTERN_CHOICES, default='STD_PREFIX_YY_SEQ5', blank=True)
...
class User(AbstractUser):
    ...
    # Soft delete flag — data is kept but user is treated as deleted
