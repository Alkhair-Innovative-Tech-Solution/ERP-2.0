...
urlpatterns = [
    ...
    path('invoices/<int:pk>/upload-receipt/', invoice_upload_receipt, name='invoice_upload_receipt'),
    path('invoices/<int:pk>/approve/', invoice_approve, name='invoice_approve'),
    path('invoices/<int:pk>/reject/', invoice_reject, name='invoice_reject'),
]
