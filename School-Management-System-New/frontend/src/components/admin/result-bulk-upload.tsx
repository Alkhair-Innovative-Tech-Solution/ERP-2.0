...
const DEFAULT_MONTHS = ['April', 'May', 'June', 'August', 'September', 'October', 'November', 'December', 'January', 'February', 'March']

export default function ResultBulkUpload({ initialFile, initialExamType, initialMonth, availableMonths, onClose }: Props): JSX.Element {
