            ...
            state_operations=[
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('type', models.CharField(choices=[('head_office', 'Head Office'), ('school', 'School Campus'), ('college', 'College'), ('hospital', 'Hospital'), ('medical_center', 'Medical Center'), ('it_institute', 'IT Institute')], max_length=20)),
                ...
                migrations.CreateModel(
                    ...
                    fields=[
                        ...
                        ('role', models.CharField(choices=[('finance_head', 'Finance Head'), ('accounts_head', 'Accounts Head'), ('branch_manager', 'Branch Manager'), ('data_entry_operator', 'Data Entry Operator'), ('program_officer', 'Program Officer'), ('auditor', 'Auditor / Reviewer')], default='branch_manager', max_length=20)),
                        ('department', models.CharField(blank=True, max_length=100)),
                        ('employee_id', models.CharField(blank=True, max_length=50, null=True, unique=True)),
                        ('phone', models.CharField(blank=True, max_length=20)),
                        ('spending_limit', models.DecimalField(decimal_places=2, default=Decimal('5000.00'), max_digits=12)),
