...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    # Use all_objects to bypass the org-scoped OrganizationManager. A superadmin has no
    # org context, so the default manager's queryset is empty and FK validation fails
    # with "Invalid pk - object does not exist" when assigning an org to a new admin.
