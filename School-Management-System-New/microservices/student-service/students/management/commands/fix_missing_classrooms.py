...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        # _base_manager: management commands have no request user in context,
        # so the org-scoped default manager would return an empty queryset.
        ...
        for student in students:
            ...
            classroom = ClassRoom._base_manager.filter(
                organization=org,
