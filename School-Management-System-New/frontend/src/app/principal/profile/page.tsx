    ...
    async function fetchStats() {
      try {
        ...
        const pendingActions: PendingActionItem[] = [
          { title: "Result Approvals",     count: resultApprovals,     type: "urgent" as const, href: "/principal/result-approval" },
          { title: "Leave Requests",       count: leaveRequests,       type: "normal" as const, href: "/principal/requests"        },
          { title: "Transfer Requests",    count: transferRequests,    type: "normal" as const, href: "/admin/transfers"                 },
          { title: "Coordinator Requests", count: coordinatorRequests, type: "normal" as const, href: "/principal/requests"        },
          ...(otherCount > 0
            ? [{ title: "Other Requests", count: otherCount, type: "normal" as const, href: "/principal/requests" }]
            : []),
        ].filter(a => a.count > 0)
