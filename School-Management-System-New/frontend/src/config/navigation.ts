...
export const NAVIGATION_ITEMS: NavItem[] = [
    {
        ...
        href: (role) => role === "coordinator" ? "/coordinator" : "/admin",
        show: (p, role) => {
    ...
    },
    {
        ...
        icon: Receipt,
        href: "/admin/billing",
        show: (_, role) => ["superadmin", "admin", "org_admin"].includes(role),
        priority: 9
    },
    {
        key: "permissions",
    ...
    },
    {
        ...
        title: "Students List",
        icon: Users,
        href: (role) => role === "coordinator" ? "/coordinator/student-list" : "/admin/students/student-list",
    ...
    },
    {
        ...
        title: "Teachers List",
        icon: GraduationCap,
        href: (role) => role === "coordinator" ? "/coordinator/teacher-list" : "/admin/teachers/list",
    ...
    },
    {
        ...
        icon: FileText,
        href: (role) => role === "principal" ? "/principal/result-approval" : "/coordinator/result-approval",
    ...
    },
    {
        ...
        title: "Support Desk",
        icon: ClipboardList,
        href: (role) => role === "principal" ? "/principal/requests" : "/coordinator/requests",
    ...
    },
    {
        ...
        title: "Time Table",
        icon: CalendarDays,
        href: "/coordinator/time-table",
        show: (p, role) => role !== "superadmin" && role !== "teacher" && p.canViewTimetable,
        priority: 70
    },
    {
        key: "teacher_my_timetable",
        title: "My Timetable",
        icon: CalendarDays,
    ...
    },
    {
        ...
        icon: Calendar,
        href: "/coordinator/attendance-review",
    ...
    // ── Admin Subjects Management ───────────────────────────────
    {
        ...
        icon: BookOpen,
        href: "/admin/subjects",
        show: (_, role) => role === "coordinator",
        priority: 78
    },
    // ── Teacher Content & Assignments ───────────────────────────
    {
        key: "teacher_assignments_nav",
        title: "Assignments",
        icon: ClipboardList,
...
export function getSortedNavigation(permissions: Permissions, role: UserRole): SortedNavItem[] {
    ...
    if (role === 'teacher') {
        const teacherOrder = [
            "teacher_assignments_nav",
            "teacher_my_timetable",
            "class_stats",
            "student_list",
            "timetable",
            "mark_attendance",
