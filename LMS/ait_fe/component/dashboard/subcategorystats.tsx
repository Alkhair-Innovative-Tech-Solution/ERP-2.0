...
const SubCategoryStats = ({ stats }: { stats: any[] }) => {
  if (!stats?.length) {
    return (
  ...
  return (
    <div className="bg-white p-4 rounded-xl shadow-lg transition-shadow hover:shadow-xl">
      <h2 className="text-xl font-bold text-gray-800 mb-4">📊 Subcategory Performance</h2>
          ...
          return (
            ...
            >
              <div className="flex justify-between items-center mb-1">
                <span className="font-medium text-gray-700">{item.subcategory_name}</span>
