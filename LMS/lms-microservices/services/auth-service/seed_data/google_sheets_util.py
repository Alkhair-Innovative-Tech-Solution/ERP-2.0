...
def get_service():
    ...
    if not os.path.exists(token_path) and os.path.exists("/app/token.json"):
        token_path = "/app/token.json"
    elif not os.path.exists(token_path) and os.path.exists("../token.json"):
        token_path = "../token.json"

    creds_path = "credentials.json"
    if not os.path.exists(creds_path) and os.path.exists("/app/credentials.json"):
        creds_path = "/app/credentials.json"
    elif not os.path.exists(creds_path) and os.path.exists("../credentials.json"):
        creds_path = "../credentials.json"
