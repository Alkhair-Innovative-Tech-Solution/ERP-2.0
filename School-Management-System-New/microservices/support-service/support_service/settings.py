...
STATIC_URL = "/support-admin/static/"
...
# ── Django admin over the gateway (https://ams.idaraalkhair.sbs/support-admin/) ──
...
SESSION_COOKIE_NAME = "support_sessionid"
CSRF_COOKIE_NAME = "support_csrftoken"
